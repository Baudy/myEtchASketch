...
<div class="row">
    ...
    <div class="col-md-4">
        ...
        <p>You can easily publish to Microsoft Azure using Python Tools for Visual Studio. Find out how you can host your application using a free trial today.  Or if you already have - well done!</p>
